...
const Deadlines: React.FC = () => {
  ...
  const moc = useMemo(() => {
    ...
    (data.chuaHieuLuc || []).forEach((c: any) => {
      arr.push({
        ngay: c.ngay,
    ...
    <section id="han-chot">
      <div className="wrap">
        ...
        <div className="warnbox" id="hanNote">
          <b>Hai lưu ý khi đọc mục này.</b> Thứ nhất, {data.diemMu?.mocTinhRa || 0} mốc có ngày cụ thể là do{' '}
